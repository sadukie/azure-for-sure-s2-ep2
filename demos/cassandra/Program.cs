...
namespace CassandraQuickStartSample
{
    public class Program
    {
        ...
        private static string UserName = Environment.GetEnvironmentVariable("CASSANDRA_USERNAME")!; 
        private static string Password = Environment.GetEnvironmentVariable("CASSANDRA_PASSWORD")!;
        private static string CassandraContactPoint = Environment.GetEnvironmentVariable("CASSANDRA_CONTACT_POINT")!;  // DnsName  
